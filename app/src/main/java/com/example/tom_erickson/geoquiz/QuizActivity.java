...
public class QuizActivity extends AppCompatActivity {
    ...
    private void checkAnswer(boolean userPressedTrue) {     //checks correct answer
    ...
    @Override
    protected void onCreate(Bundle savedInstanceState) {    //creates app
        super.onCreate(savedInstanceState);
        Log.d(TAG, "onStart() called");    //Logs onStart

        setContentView(R.layout.activity_quiz);

        mQuestionTextView = (TextView) findViewById(R.id.question_text_view);

        mTrueButton = (Button) findViewById(R.id.true_button);      //compares button touch to correct answer
        ...
        mNextButton = (Button) findViewById(R.id.next_button);      //moves to the next question when button touched
